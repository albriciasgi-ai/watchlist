...
async def forward_to_trading_bot(request: Request):
    """
    Receive alert from watchlist and forward to TradingBot
    Acts as a bridge between watchlist (port 5000) and TradingBot (port 8001)
    ...
    try:
        ...
        # Add to recent alerts for dashboard
